...
<body>
    ...
    <table>
        ...
        <?php foreach ($_SESSION["pacientes"] as $paciente){ ?>
            <tr>
                <td><?php echo $paciente["codPaciente"] ?></td>
                <td><?php echo $paciente["nomPaciente"] ?></td>
                <td><?php echo $paciente["apePaciente"] ?></td>
                <td><?php echo $paciente["atendido"] ?></td>
                <td><a href="index.php?accion=marcarAtendido&codPaciente=<?= $paciente["codPaciente"]?>">Marcar atendido</a></td>
            </tr>
        <?php
            }
        ?>
